...
load.MouseButton1Down:connect(function()
	...
	elseif game.PlaceId == 13822889 then 
        ...
        elseif game.PlaceId == 2753915549 then
                 loadstring(game:HttpGet("https://raw.githubusercontent.com/SinshubCreator/Strongest-Punch-Simulator/main/Blox%20Fruits"))()
...
exit.MouseButton1Down:connect(function()
   game.Players.LocalPlayer:Kick("pls rejoin")
end)
